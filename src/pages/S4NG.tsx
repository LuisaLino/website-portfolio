...
export default function S4NG() {
  return (
    <div className='min-h-screen'>
      ...
      <div className='max-w-5xl mx-auto px-4 lg:px-8 pt-48 pb-16'>
        {/* Header */}
        <div className='mb-12'>
        ...
        <div className='md:mb-16 mb-8 max-w-[830px]'>
          <p className='font-title text-2xl leading-tight font-light'>
            Project carried out in the context of the master's dissertation.
            This work addresses the creation of an accessible platform that aims
            to provide tools, informative and gamified content, to support the
            academic community in exclusive contexts.
          </p>
        </div>
        ...
        <div className='grid md:grid-cols-2 grid-cols-1 gap-8 md:mb-16 mb-8'>
          <div className='flex flex-col gap-3'>
            ...
            <p className='text-lg font-light leading-tight mb-3'>
              The Skills for a Next Generation platform must offer an intuitive
              and accessible interface that enables University of Porto faculty
              to share and discover inclusive educational strategies, ensuring
              ease of use for diverse user needs.
            </p>
            <img src={Problem} className='align-bottom' />
          </div>

          <div className='flex flex-col gap-3'>
            <h3 className='!text-2xl font-body font-semibold mb-6'>Solution</h3>
            <p className='text-lg font-light leading-tight'>
              The solution offers a user-centred platform that facilitates
              content sharing among students, teachers and staff. It includes a
              feedback portal, sections for digital and physical games, and
              data-driven infographics presenting University of Porto statistics
        ...
        <div className='flex flex-col gap-3'>
          ...
          <div>
            <p className='text-lg font-light leading-tight mb-4 max-w-[830px]'>
              Led a comprehensive research process using interviews, focus
              groups, shadowing, online surveys, and digital cultural probes to
              uncover user needs and identify pain points in inclusive
              education.
            </p>
        ...
        <div className='flex flex-col gap-6 md:mb-16 mb-8'>
          ...
          <p className='text-lg font-light leading-tight md:mb-14 max-w-[830px]'>
            ...
            sharing personal stories, exploring gamified learning tools,
            receiving support for inclusive teaching, or accessing helpful
            resources. These scenarios were key to identifying user expectations
            and shaping the platform’s functionality around their needs.
          </p>
          ...
          <div className='md:my-14 my-10 grid md:grid-cols-2 grid-cols-1 gap-y-9 gap-x-6'>
            ...
            <div className='space-y-4'>
              <img src={Persona2} />
              <div className='font-light'>
                Marco, a member of the LGBTQIA+ community, seeks a respectful
                and accepting environment where his identity is recognized by
            ...
            <div className='space-y-4'>
              <img src={Persona4} />
              <div className='font-light'>
                Carla, a staff member, experiences mobility issues when
                accessing the library and aims to improve accessibility and
          ...
          <div className='space-y-4 mb-6 max-w-[830px]'>
            <div className='flex items-start'>
              <span className='text-lg leading-tight font-light'>
                The platform's structure was designed around the following
                needs:
              </span>
            </div>
            <div className='flex items-start'>
            ...
            <div className='flex items-start'>
              <span className='font-title mr-3'>→</span>
              <span className='text-lg leading-tight font-light'>
                Usability & Experience: Ensures accessibility, compatibility
                with assistive technologies, keyboard navigation, and an
            ...
            <div className='flex items-start'>
              ...
              <span className='text-lg leading-tight font-light'>
                ...
                with or without a camera or audio, and maintains high contrast
                for visibility.
              </span>
            </div>
            <div className='flex items-start'>
        ...
        <div className='flex flex-col gap-3 md:mb-16 mb-8'>
          ...
          <div className='space-y-3 '>
            ...
            <p className='text-lg font-light leading-tight md:mb-14 max-w-[830px]'>
              ...
              inclusivity. The selected colors were carefully balanced to
              provide sufficient contrast, support readability, and maintain a
              clean, professional look suitable for an academic context.
            </p>
          ...
          <p className='text-lg font-light leading-tight max-w-[830px] md:my-14 my-10'>
            By creating a high-fidelity prototype in Figma based on the
            wireflows and the low-fidelity version, the platform was given a
            more polished and realistic appearance. This allowed the project to
            move forward to initial usability testing. The prototype was tested
            with 8 potential users, including 3 professors and 5 students.
          </p>
          ...
          <div className='flex flex-col gap-4'>
            ...
            <p className='text-sm text-gray-700 text-center'>
              High-Fidelity Prototype of the Skills for a Next Generation
              Platform
            </p>
          </div>
        </div>
        ...
        <div className='flex flex-col gap-3 md:mb-16 mb-8'>
          ...
          <div className='space-y-3'>
            ...
            <p className='text-lg font-light leading-tight md:mb-14 max-w-[830px]'>
              All the games created by the Skills for a Next Generation team
              were presented and tested during the session, including the
              Treasure Hunt and Role Play games.
            </p>
            ...
            <div className='flex flex-col gap-4'>
              ...
              <p className='text-sm text-gray-700 text-center'>
                Presentation and testing of the digital Treasure Hunt game and
                the Role Play card game
              </p>
            </div>
          </div>
        </div>
        ...
        <div className='flex flex-col gap-3 max-w-[830px]'>
          ...
          <p className='text-lg font-light leading-tight'>
            Design plays a crucial role in promoting social inclusion by
            creating solutions that respect diversity and involve users
            throughout the process. Successful inclusive design relies on
            collaboration, continuous user research, and ethical practices to
            develop accessible, engaging, and meaningful experiences.
          </p>
          <p className='text-lg font-light leading-tight'>
            Continuous feedback loops and iterative design will be essential to
            refine the platform and ensure it effectively meets the evolving
