    ...
    <div className='min-h-screen'>
      ...
      <div className='max-w-5xl mx-auto px-8 pt-48 pb-16'>
        ...
        <div className='mb-12'>
          ...
          <div className='flex justify-between items-center'>
            <h1 className='text-4xl font-normal   leading-tight'>
              VIA-MAP | Workflow Designer
            </h1>
            <div className='text-right'>
              <p>Technology — 2024/2025</p>
            </div>
          </div>
        </div>
        ...
        <div className='mb-16 max-w-[830px]'>
          <p className='font-title text-2xl font-light'>
            First-time design of VIA-MAP’s Workflow Designer — a flexible
            interface for creating media workflows. Designed to empower
            broadcast engineers and operations teams to visually orchestrate
            ingest, QC, transcode, and playout processes without writing code.
          </p>
        </div>
        ...
        <div className='grid md:grid-cols-2 grid-cols-1 gap-8 mb-16'>
          <div className='flex flex-col gap-3'>
            ...
            <p className='text-lg font-light leading-tight'>
              Many organizations struggle with inefficient workflow management
              due to lack of clear visualization and customization options,
              leading to communication gaps, delays, and errors in process
              execution.
            </p>
          </div>
          ...
          <div className='flex flex-col gap-3'>
            ...
            <p className='text-lg font-light leading-tight'>
              Workflow Designer provides an easy-to-use, visual platform where
              users can design, modify and monitor workflows dynamically. It
        ...
        <div className='flex flex-col gap-3 mb-16 max-w-[830px]'>
          ...
          <div>
            <p className='text-lg font-light leading-tight mb-4'>
              ...
              Owners, Project Managers, Engineers, and Workflow Experts to
              define user needs and translate them into a seamless design.
            </p>
            <p className='text-lg font-light leading-tight'>
            ...
            <div className='flex items-start'>
              ...
              <div className='text-lg leading-tight font-light'>
                ...
                <span>
                  ...
                  highlight actionable elements, such as decision-making tasks
                  and workflows, drawing the user's attention.
                </span>
              </div>
            </div>
        ...
        <div className='flex flex-col gap-3 mb-16 max-w-[830px]'>
          ...
          <p className='text-lg font-light leading-tight'>
            Designing this tool from scratch required close alignment with
            technical constraints and user expectations. Despite some
            unavoidable complexity, we created a scalable, visual-first
            experience that empowers a wider range of users to manage media
